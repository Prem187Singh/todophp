<?php
    ...
    if($_SESSION['logged_in'] == true){  
        header("location:http://localhost/todoPhp/home.php?username=$_SESSION[username]");
    }
?>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 offset-md-3 formcontainer">
                <h1 class="d-flex justify-content-center mt-5">Welcome</h1>
                ...
                <div class="d-flex justify-content-end mycolor">
                    <a href="">Forget Password</a>
                </div>
                <div class="d-flex justify-content-center mycolor">
